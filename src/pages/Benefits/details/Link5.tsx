    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Using a single platform for print development helps maintain visual consistency across womenswear, menswear, accessories, and home products. Designs can easily be adapted for multiple collections and retail channels.
          </p>
