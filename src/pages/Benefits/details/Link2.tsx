    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Rapid repeat creation, easy recoloring, and quick visual mockups help reduce the time required for print development. Teams can respond quickly to trends, refresh key styles, and release updated collections faster.
          </p>
