    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Well-organized layered artwork with correct resolution and sizing ensures smoother communication with print vendors. Printers can produce more accurate results with fewer corrections and delays.
          </p>
